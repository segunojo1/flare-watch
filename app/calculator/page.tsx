...
const Calculator = () => {
  ...
  return (
    <div className={`${mapSans.className} min-h-screen w-full bg-[#0A0A0A] px-3 pb-12 md:px-8`}>
      <div className="mx-auto max-w-7xl py-8">
        {/* Hero Section */}
        <div className="mb-12 border border-[#2D2D2D] bg-gradient-to-b from-[#1A1A1A] to-[#0A0A0A] p-8">
          <p className="text-[12px]/[18px] uppercase tracking-[2px] text-[#A3A3A3]">
            ECONOMIC RECOVERY SCENARIO
          </p>
          <h1 className={`${mapSerif.className} mt-3 text-[48px]/[56px] italic text-white`}>
            What if we captured this gas?
          </h1>
          <p className="mt-4 max-w-2xl text-[14px]/[21px] text-[#737373]">
            Nigeria burns {formatNumber(scenario.methaneTons)} tons of methane daily. Adjust the
            capture and utilization rates below to see the economic and environmental impact of gas
            recovery.
          </p>
        </div>
        ...
        <div className="mb-12 grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="border border-[#2D2D2D] bg-[#0A0A0A] p-6">
            ...
            <p className="mt-4 text-[11px]/[16px] text-[#525252]">
              How much of the daily flaring volume can be technically captured and processed.
            </p>
          </div>
          ...
          <div className="border border-[#2D2D2D] bg-[#0A0A0A] p-6">
            ...
            <p className="mt-4 text-[11px]/[16px] text-[#525252]">
              What percentage of captured gas is successfully converted to energy or products.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="border border-[#2D2D2D] bg-[#0A0A0A] p-6">
            ...
            <p className={`${mapSerif.className} mt-2 text-[32px]/[40px] italic font-bold`}>
              {formatNumber(scenario.dailyFlaring)}
            </p>
            <p className="mt-2 text-[10px]/[15px] text-[#525252]">MSCF (1000 cu ft)</p>
          </div>
          ...
          <div className="border border-[#FF6B00] bg-[#FF6B00]/5 p-6">
            ...
            <p className={`${mapSerif.className} mt-2 text-[32px]/[40px] italic font-bold text-[#FF6B00]`}>
              {formatNumber(scenario.capturedVolume)}
            </p>
            <p className="mt-2 text-[10px]/[15px] text-[#FFB089]">MSCF @ {captureRate}%</p>
          </div>
          ...
          <div className="border border-[#2A5B8A] bg-[#0D1C2C] p-6">
            ...
            <p className={`${mapSerif.className} mt-2 text-[32px]/[40px] italic font-bold text-[#9DC7FF]`}>
          ...
          <div className="border border-[#D64545] bg-[#2C1515] p-6">
            ...
            <p className={`${mapSerif.className} mt-2 text-[28px]/[36px] italic font-bold text-[#FF9999]`}>
              {formatCurrency(scenario.dailyLoss)}
            </p>
            <p className="mt-2 text-[10px]/[15px] text-[#FF9999]">Gas at market price</p>
          </div>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="border border-[#2D8659] bg-[#0D1F16] p-6">
            ...
            <p className={`${mapSerif.className} mt-3 text-[36px]/[44px] italic font-bold text-[#52D77F]`}>
              {formatCurrency(scenario.recoveredValue * 365)}
            </p>
            <div className="mt-4 space-y-2 text-[11px]/[16px] text-[#52D77F]/75">
              <p>• Recovered: {formatNumber(scenario.utilizedVolume)} MSCF/day</p>
          ...
          <div className="border border-[#2A5B8A] bg-[#0D1C2C] p-6">
            ...
            <p className={`${mapSerif.className} mt-3 text-[36px]/[44px] italic font-bold text-[#9DC7FF]`}>
              {formatNumber(scenario.co2Prevented * 365)}
            </p>
            <div className="mt-4 space-y-2 text-[11px]/[16px] text-[#9DC7FF]/75">
              <p>• Prevented: {(scenario.co2Prevented * 365 / 1e6).toFixed(1)}M tons CO₂e</p>
              <p>• Current Total: {formatNumber(scenario.co2Equivalent * 365)}</p>
            </div>
          </div>
          ...
          <div className="border border-[#8A5B2A] bg-[#2C1810] p-6">
            ...
            <p className={`${mapSerif.className} mt-3 text-[32px]/[40px] italic font-bold text-[#FFB89B]`}>
        ...
        <div className="mt-12 border border-[#232323] bg-[#0F0F0F] p-6">
          <p className="text-[11px]/[16px] text-[#525252]">
            💡 These calculations are based on live NASA FIRMS satellite data and industry benchmarks.
            Adjusting the sliders models different technological and operational scenarios. Capture
            efficiency factors in infrastructure constraints, while utilization rate models energy

...
const Hero = () => {
  return (
    <div className='flex'>
        <h1 className='text-[96px]/[96px] newsreader-font -tracking-[2.4px] '>
            FlareWatch exists because <span className='text-[#FF6B00] '>data</span> makes injustice visible.
        </h1>
        ...
        <div>
            ...
            <p className='text-[12px]/[16px] font-bold text-[#A98A7D]'>DATA SOVEREIGNTY PARTNERS</p>
        </div>
    </div>
  )
}
